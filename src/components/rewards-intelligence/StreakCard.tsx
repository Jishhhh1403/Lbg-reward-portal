...
export default function StreakCard({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-gold-200/80 bg-gradient-to-br from-gold-50 to-brand-50 p-4 shadow-card">
      ...
      <div className="mb-3 text-center">
        <motion.div
          className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-gold-400 to-brand-500"
      ...
      {nextReward && (
        <div className="mb-3 rounded-xl bg-gold-400/20 p-2 text-center">
